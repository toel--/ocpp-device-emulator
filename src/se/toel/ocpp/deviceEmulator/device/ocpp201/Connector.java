...
public class Connector extends DataMap implements ConnectorIF {
    ...
    private boolean isRegulFcrdd = false;
    ...
    public Connector(int id, String storePath) {
        this.id = id;
        set(CHARGING_CURRENT, "12");
        set(ERROR_CODE, "NoError");
        set(VENDOR_ERROR_CODE, "");
        set(GRID_FREQVENCY, "50");
    ...
    public double getGridFrequency() {
        ...
        double freq = _getDouble(GRID_FREQVENCY);
        
        if (freq<49.8) {
            freq += Math.random()/100;
        } else if (freq<49.9) {
            freq += (0.75d - Math.random()) / 100;
        } else if (freq>50.1) {
            freq -= (0.75d - Math.random()) / 100;
        } else if (freq>50.2) {
            freq -= Math.random()/100;
        } else {
            freq += (0.5d - Math.random()) / 100;
        }
        
        _set(GRID_FREQVENCY, freq);
    ...
    public JSONArray getMeterValues() {
        ...
        String sNow = DateTimeUtil.toIso8601(now);
        
        System.out.println(now+" : "+sNow);
        
        meterValue.put("timestamp", sNow);
        JSONArray sampledValues = new JSONArray();
        meterValue.put("sampledValue", sampledValues);
        json.put(meterValue);
                        
        JSONObject sampledValue;
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "InsAcPow");                         // Instant Active Power 
        sampledValue.put("value", "17000"); // String.valueOf(getMeterWh()));
        sampledValue.put("unitOfMeasure", "W");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "GridFreq");
        sampledValue.put("value", getGridFrequency());
        sampledValue.put("unitOfMeasure", "Hz");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "grid_freq_raw");
        sampledValue.put("value", getGridFrequency()+(0.5 - Math.random())/10);
        sampledValue.put("unitOfMeasure", "Hz");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "fcrd_do_mode");
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "enum");
        sampledValues.put(sampledValue);
        
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "fcrd_do_status");
        sampledValue.put("value", isRegulFcrdd);
        sampledValue.put("unitOfMeasure", "bool");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "fcrd_do_reg_str");
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "W/mHz");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "Pmin");
        sampledValue.put("value", -100);
        sampledValue.put("unitOfMeasure", "W");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "Pmax");
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "W");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "ctrl_output");
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "W");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "baseline_setpoint");
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "W");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "fcrd_do_activated");
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "W");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "fcrd_do_ctrl_set");
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "W");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "baseline_status");
        sampledValue.put("value", false);
        sampledValue.put("unitOfMeasure", "bool");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "fcrd_do_scheduled");
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "W");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "baseline_power");
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "W");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "temperature_flange_1"); 
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "C");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "temperature_flange_2"); 
        sampledValue.put("value", 0);
        sampledValue.put("unitOfMeasure", "C");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "water_level_1_1"); 
        sampledValue.put("value", false);
        sampledValue.put("unitOfMeasure", "bool");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "water_level_1_2");
        sampledValue.put("value", false);
        sampledValue.put("unitOfMeasure", "bool");
        sampledValues.put(sampledValue);
        
        sampledValue = new JSONObject();
        sampledValue.put("measurand", "safety_af370"); 
        sampledValue.put("value", false);
        sampledValue.put("unitOfMeasure", "bool");
        sampledValues.put(sampledValue);
